...
def quicksort(i, l, h, strategy):
    while l < h:
        ...
        # otherwise, we choose the first element to implement
        # the deterministic pivot selection approach
        else:
...
# checks that the quicksort algorithm works on
...
# executes the code to generate the results for part 1 data
